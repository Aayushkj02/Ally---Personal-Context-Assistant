...
describe('Ally Policy Engine - Mandatory Tests', () => {
  ...
  it('TEST 2: PERSISTENT PREFERENCE', () => {
    const prefs: Preference[] = [{
      id: 'p1', profileId: 'prof_1', capability: 'brightness', value: 40,
      source: 'user', sourceCommand: null, createdAt: 0
    }];
  ...
  it('TEST 3: TEMPORARY OVERRIDE', () => {
    ...
    const activeOverrides = getActiveOverrides([{
      id: 'o1', profileId: 'prof_1', capability: 'brightness', value: 10,
      subject: null, effect: 'allow', startAt: NOW, expiresAt: NOW + 10000,
      active: true, sourceCommand: null
    }], 'prof_1', NOW);
    const entry = resolveCapability('brightness', EMPTY_INTENT, activeOverrides, prefs, MODE_DEFAULTS);
  ...
  it('TEST 4: EXPIRED OVERRIDE', () => {
    ...
    const activeOverrides = getActiveOverrides([{
      id: 'o1', profileId: 'prof_1', capability: 'brightness', value: 10,
      subject: null, effect: 'allow', startAt: NOW - 20000, expiresAt: NOW - 10000,
      active: true, sourceCommand: null
    }], 'prof_1', NOW);
  ...
  it('TEST 7: PROFILE ISOLATION', () => {
    const prefs: Preference[] = [{
      id: 'p1', profileId: 'prof_2', capability: 'brightness', value: 40,
      source: 'user', sourceCommand: null, createdAt: 0
    }];
    const activeOverrides = getActiveOverrides([{
      id: 'o1', profileId: 'prof_OTHER', capability: 'brightness', value: 10,
      subject: null, effect: 'allow', startAt: NOW, expiresAt: NOW + 10000,
      active: true, sourceCommand: null
    }], 'prof_1', NOW);
  ...
  it('TEST 8: MULTIPLE CAPABILITIES (Realistic Scenario)', () => {
    const prefs: Preference[] = [
      { id: 'p1', profileId: 'prof_1', capability: 'brightness', value: 40, source: 'user', sourceCommand: null, createdAt: 0 },
      { id: 'p2', profileId: 'prof_1', capability: 'dnd', value: 'priority', source: 'user', sourceCommand: null, createdAt: 0 }
    ];
    
    const intent: Intent = {
      ...EMPTY_INTENT,
      requestedChanges: [{ capability: 'brightness', value: 60 }],
      exceptions: [{ type: 'contactGroup', value: 'project group', effect: 'allow', durationMinutes: 20 }]
    };
  ...
  it('TEST 9: MULTIPLE OVERRIDES', () => {
    const activeOverrides = getActiveOverrides([
      { id: 'o1', profileId: 'prof_1', capability: 'brightness', value: 10, subject: null, effect: 'allow', startAt: NOW - 5000, expiresAt: NOW + 5000, active: true, sourceCommand: null },
      { id: 'o2', profileId: 'prof_1', capability: 'brightness', value: 20, subject: null, effect: 'allow', startAt: NOW - 1000, expiresAt: NOW + 10000, active: true, sourceCommand: null }
    ], 'prof_1', NOW);
  ...
  it('TEST 10: UNKNOWN CAPABILITY', () => {
    const entry = resolveCapability('made_up_capability' as Capability, EMPTY_INTENT, [], [], MODE_DEFAULTS);
    expect(entry).toBeNull();
  });

  it('TEST 11: INVALID VALUE', () => {
    const prefs: Preference[] = [{
      id: 'p1', profileId: 'prof_1', capability: 'brightness', value: -50,
      source: 'user', sourceCommand: null, createdAt: 0
    }];
    expect(() => {
